...
- Component icons redrawn in the Grasshopper house style (amber surfaces, orange-red meshes, green analysis, timber fabrication, grey util; the tab icon is the K mark) — `tools/generate_icons.py`.
